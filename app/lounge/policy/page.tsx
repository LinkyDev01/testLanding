  ...
  return (
    <main className="bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 break-keep">
        <h1 className="text-3xl font-bold mb-8 mt-8">교환/환불 안내</h1>
  ...
  return (
    <>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-[#9CB7A4]">1. 환불 가능 기준</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-[#9CB7A4]">2. 환불 시 유의사항</h2>
        <ul className="space-y-3 text-foreground/80">
          <li className="flex gap-2">
            <span className="text-[#9CB7A4]">•</span>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-[#9CB7A4]">3. 환불 불가 시점</h2>
        <ul className="space-y-3 text-foreground/80">
          <li className="flex gap-2">
            <span className="text-[#9CB7A4]">•</span>
            <span>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-[#9CB7A4]">4. 환불 신청 방법</h2>
        <ul className="space-y-3 text-foreground/80">
          <li className="flex gap-2">
            <span className="text-[#9CB7A4]">•</span>
            <span>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-[#9CB7A4]">5. 모임 미개설 시</h2>
        <ul className="space-y-3 text-foreground/80">
          <li className="flex gap-2">
            <span className="text-[#9CB7A4]">•</span>
...
function WinePolicy() {
  return (
    <>
      ...
      {/* 교환/환불 안내 */}
      <h2 className="text-2xl font-bold mb-6 mt-12 text-[#9CB7A4]">교환/환불 안내</h2>
