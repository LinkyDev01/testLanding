      ...
      <div className="bg-white rounded-xl p-10 shadow-[0_4px_20px_rgba(15,23,42,0.05)]">
        ...
        <Section title="제1장 총칙">
          ...
          <SubSection title="제2조 (정의)">
            ...
            <TermDefinition term="링키 파트너 회원">
              무인공간에서 단기 근로를 희망하는 개인 회원을 말합니다.
            </TermDefinition>

            <TermDefinition term="매칭">
              플랫폼을 통해 운영자 회원과 링키 파트너 회원이 근로 계약을 체결하는 것을 말합니다.
            </TermDefinition>

            <TermDefinition term="AI 가이드">
              링키 파트너 회원의 작업을 지원하기 위해 제공되는 인공지능 기반 작업 안내 시스템을 말합니다.
            </TermDefinition>
          </SubSection>
        ...
        <Section title="제4장 매칭 및 근로 계약">
          <SubSection title="제11조 (매칭 신청 및 성사)">
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                링키 파트너 회원은 자신의 조건에 맞는 근로 요청을 확인하고 수락할 수 있습니다.
              </li>
              <li>
          ...
          <SubSection title="제12조 (근로 계약의 이행)">
            <ol className="list-decimal list-inside space-y-2">
              <li>
                링키 파트너 회원은 약속된 시간과 장소에 출근하여 성실히 근로를 수행해야 합니다.
              </li>
              <li>
          ...
          <SubSection title="제13조 (근로 계약의 취소 및 변경)">
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                링키 파트너 회원은 근로 예정일 1시간 전까지 취소할 수 있으며,
        ...
        <Section title="제5장 결제 및 환불">
          ...
          <SubSection title="제15조 (급여 지급)">
            <ol className="list-decimal list-inside space-y-2">
              <li>
                링키 파트너 회원의 급여는 근로 완료 후 익일 지급을 원칙으로 합니다.
              </li>
              <li>급여는 링키 파트너 회원이 등록한 계좌로 입금됩니다.</li>
              <li>
          ...
          <SubSection title="제21조 (플랫폼의 역할과 책임)">
            <Highlight>
              <p className="font-semibold">
                중요: 회사는 운영자 회원과 링키 파트너 회원 간의 근로 계약을 중개하는 플랫폼 제공자이며,
                근로 계약의 당사자가 아닙니다.
              </p>
            </Highlight>
            <ol className="list-decimal list-inside space-y-2">
